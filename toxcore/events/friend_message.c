...
static void tox_event_friend_message_set_friend_number(non_null() Tox_Event_Friend_Message *friend_message, uint32_t friend_number)
{
...
static void tox_event_friend_message_set_type(non_null() Tox_Event_Friend_Message *friend_message, Tox_Message_Type type)
{
    assert(friend_message != nullptr);
...
static bool tox_event_friend_message_set_message(non_null() Tox_Event_Friend_Message *friend_message,
...
static void tox_event_friend_message_construct(non_null() Tox_Event_Friend_Message *friend_message)
{
    *friend_message = (Tox_Event_Friend_Message) {
        0
    };
}
static void tox_event_friend_message_destruct(non_null() Tox_Event_Friend_Message *friend_message, non_null() const Memory *mem)
{
    free(friend_message->message);
}
...
static bool tox_event_friend_message_unpack_into(non_null() Tox_Event_Friend_Message *event, non_null() Bin_Unpack *bu)
{
...
static Tox_Event_Friend_Message *tox_events_add_friend_message(non_null() Tox_Events *events, non_null() const Memory *mem)
{
...
static Tox_Event_Friend_Message *tox_event_friend_message_alloc(non_null() void *user_data)
{
