...
static void tox_event_group_private_message_set_group_number(non_null() Tox_Event_Group_Private_Message *group_private_message, uint32_t group_number)
{
...
static void tox_event_group_private_message_set_peer_id(non_null() Tox_Event_Group_Private_Message *group_private_message, uint32_t peer_id)
{
    assert(group_private_message != nullptr);
...
static void tox_event_group_private_message_set_message_type(non_null() Tox_Event_Group_Private_Message *group_private_message, Tox_Message_Type message_type)
{
    assert(group_private_message != nullptr);
...
static bool tox_event_group_private_message_set_message(non_null() Tox_Event_Group_Private_Message *group_private_message,
...
static void tox_event_group_private_message_set_message_id(non_null() Tox_Event_Group_Private_Message *group_private_message, uint32_t message_id)
{
    assert(group_private_message != nullptr);
...
static void tox_event_group_private_message_construct(non_null() Tox_Event_Group_Private_Message *group_private_message)
{
    *group_private_message = (Tox_Event_Group_Private_Message) {
        0
    };
}
static void tox_event_group_private_message_destruct(non_null() Tox_Event_Group_Private_Message *group_private_message, non_null() const Memory *mem)
{
    free(group_private_message->message);
}
...
static bool tox_event_group_private_message_unpack_into(non_null() Tox_Event_Group_Private_Message *event, non_null() Bin_Unpack *bu)
{
...
static Tox_Event_Group_Private_Message *tox_events_add_group_private_message(non_null() Tox_Events *events, non_null() const Memory *mem)
{
...
static Tox_Event_Group_Private_Message *tox_event_group_private_message_alloc(non_null() void *user_data)
{
