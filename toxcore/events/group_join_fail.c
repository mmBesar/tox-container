...
static void tox_event_group_join_fail_set_group_number(non_null() Tox_Event_Group_Join_Fail *group_join_fail, uint32_t group_number)
{
...
static void tox_event_group_join_fail_set_fail_type(non_null() Tox_Event_Group_Join_Fail *group_join_fail, Tox_Group_Join_Fail fail_type)
{
    assert(group_join_fail != nullptr);
...
static void tox_event_group_join_fail_construct(non_null() Tox_Event_Group_Join_Fail *group_join_fail)
{
    *group_join_fail = (Tox_Event_Group_Join_Fail) {
        0
    };
}
static void tox_event_group_join_fail_destruct(non_null() Tox_Event_Group_Join_Fail *group_join_fail, non_null() const Memory *mem)
{
    return;
}
...
static bool tox_event_group_join_fail_unpack_into(non_null() Tox_Event_Group_Join_Fail *event, non_null() Bin_Unpack *bu)
{
...
static Tox_Event_Group_Join_Fail *tox_events_add_group_join_fail(non_null() Tox_Events *events, non_null() const Memory *mem)
{
...
static Tox_Event_Group_Join_Fail *tox_event_group_join_fail_alloc(non_null() void *user_data)
{
