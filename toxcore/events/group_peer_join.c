...
static void tox_event_group_peer_join_set_group_number(non_null() Tox_Event_Group_Peer_Join *group_peer_join, uint32_t group_number)
{
...
static void tox_event_group_peer_join_set_peer_id(non_null() Tox_Event_Group_Peer_Join *group_peer_join, uint32_t peer_id)
{
    assert(group_peer_join != nullptr);
...
static void tox_event_group_peer_join_construct(non_null() Tox_Event_Group_Peer_Join *group_peer_join)
{
    *group_peer_join = (Tox_Event_Group_Peer_Join) {
        0
    };
}
static void tox_event_group_peer_join_destruct(non_null() Tox_Event_Group_Peer_Join *group_peer_join, non_null() const Memory *mem)
{
    return;
}
...
static bool tox_event_group_peer_join_unpack_into(non_null() Tox_Event_Group_Peer_Join *event, non_null() Bin_Unpack *bu)
{
...
static Tox_Event_Group_Peer_Join *tox_events_add_group_peer_join(non_null() Tox_Events *events, non_null() const Memory *mem)
{
...
static Tox_Event_Group_Peer_Join *tox_event_group_peer_join_alloc(non_null() void *user_data)
{
