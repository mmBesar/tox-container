...
static void tox_event_friend_name_set_friend_number(non_null() Tox_Event_Friend_Name *friend_name, uint32_t friend_number)
{
...
static bool tox_event_friend_name_set_name(non_null() Tox_Event_Friend_Name *friend_name,
...
static void tox_event_friend_name_construct(non_null() Tox_Event_Friend_Name *friend_name)
{
    *friend_name = (Tox_Event_Friend_Name) {
        0
    };
}
static void tox_event_friend_name_destruct(non_null() Tox_Event_Friend_Name *friend_name, non_null() const Memory *mem)
{
    free(friend_name->name);
}
...
static bool tox_event_friend_name_unpack_into(non_null() Tox_Event_Friend_Name *event, non_null() Bin_Unpack *bu)
{
...
static Tox_Event_Friend_Name *tox_events_add_friend_name(non_null() Tox_Events *events, non_null() const Memory *mem)
{
...
static Tox_Event_Friend_Name *tox_event_friend_name_alloc(non_null() void *user_data)
{
