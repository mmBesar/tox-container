...
static void create_timed_auth_to_hash(non_null() const Mono_Time *mono_time, uint16_t timeout, bool previous, nullable() const uint8_t *data,
                                      uint16_t length, non_null() uint8_t *to_hash)
{
