...
static void sys_random_bytes(non_null() void *obj, non_null() uint8_t *bytes, size_t length)
{
    randombytes(bytes, length);
}

static uint32_t sys_random_uniform(non_null() void *obj, uint32_t upper_bound)
{
